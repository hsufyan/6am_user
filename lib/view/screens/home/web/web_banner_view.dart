...
class WebBannerView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return bannerController.bannerImageList != null
        ? CarouselSlider(
            items: bannerController.bannerImageList!
                .map(
                  (item) => Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl:
                            '${item is BasicCampaignModel ? Get.find<SplashController>().configModel!.baseUrls!.campaignImageUrl! : Get.find<SplashController>().configModel!.baseUrls!.bannerImageUrl!}/$item',
                        fit: BoxFit.cover,
                        placeholder: (context, url) => WebBannerShimmer(
