    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
              isPopular ? 'popular_items_nearby'.tr : 'best_reviewed_item'.tr,
        ...
        itemList != null
                      ...
                      children: [
                        PageView.builder(
                          ...
                          onPageChanged: (int index) =>
                              itemController.setCurrentIndex(index, true),
                          itemBuilder: (context, index) {
                            ...
                            return Row(children: [
                              Expanded(
                                  child: index1 < itemList.length
                                      ? itemCartWidget(context, index1,
                                          itemController, itemList)
                                      : const SizedBox()),
                              const SizedBox(
                                  width: Dimensions.paddingSizeSmall),
                              Expanded(
                                  child: index2 < itemList.length
                                      ? itemCartWidget(context, index2,
                                          itemController, itemList)
                                      : const SizedBox()),
                              const SizedBox(
                                  width: Dimensions.paddingSizeSmall),
                              Expanded(
                                  child: index3 < itemList.length
                                      ? itemCartWidget(context, index3,
                                          itemController, itemList)
                                      : const SizedBox()),
                              const SizedBox(
                                  width: Dimensions.paddingSizeSmall),
                              Expanded(
                                  child: index4 < itemList.length
                                      ? itemCartWidget(context, index4,
                                          itemController, itemList)
                                      : const SizedBox()),
                            ]);
                          },
                        ),
                        itemController.currentIndex != 0
                            ? Positioned(
                                top: 0,
                                bottom: 0,
                                left: -10,
                          ...
                          children: [
                              ...
                              child: Container(
                                ...
                                child: Row(children: [
                                  Stack(children: [
                                    ...
                                    itemController.isAvailable(itemList[index])
                                        ? const SizedBox()
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            RatingBar(
                                              rating: itemList[index].avgRating,
                                              size: 15,
                                              ratingCount:
                                                  itemList[index].ratingCount,
                                            ),
                                            const SizedBox(
                                                height: Dimensions
                                                    .paddingSizeExtraSmall),
                            ...
                            Visibility(
                              ...
                              child: Positioned(
                                ...
                                child: InkWell(
                                  onTap: () => Get.toNamed(
                                      RouteHelper.getPopularItemRoute(
                                          isPopular)),
                                  child: Container(
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(
            ...
            : WebCampaignShimmer(
                enabled: itemList == null, isPopular: isPopular),
      ],
    );
  }
}

Widget itemCartWidget(BuildContext context, int index,
    ItemController itemController, List<Item> itemList) {
  return Padding(
    padding: const EdgeInsets.symmetric(
      ...
      child: InkWell(
        onTap: () {
          Get.find<ItemController>()
              .navigateToItemPage(itemList[index], context);
        },
            ...
            Stack(children: [
              Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                  border: Border.all(
                      color: Theme.of(context).disabledColor, width: 0.1),
                ),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                  child: CustomImage(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                              width: itemList[index].discount! > 0
                                  ? Dimensions.paddingSizeExtraSmall
                                  : 0),
                          itemList[index].discount! > 0
                              ? Expanded(
...
class WebCampaignShimmer extends StatelessWidget {
  final bool enabled;
  final bool isPopular;
  const WebCampaignShimmer(
      {Key? key, required this.enabled, required this.isPopular})
      : super(key: key);
